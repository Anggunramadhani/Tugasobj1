...
import books.Book;
import exeption.IllegalAdminAccess;
import util.iMenu;
...
public class Student extends User implements iMenu {
    ...
    public void menu() {
        ...
        //Button
        Button borrowedBookButton = new Button("1.Buku Terpinjam");
        Button borrowBookButton   = new Button("2.Pinjam Buku");
        Button returnBookButton   = new Button("3.Kembalikan Buku");
